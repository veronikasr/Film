...
const url = "https://api.themoviedb.org/3/movie/now_plaiyng?api_key=${API_KEY}&language=uk-UA&page1";
...
.then(data => {
    ...
    data.results.forEach(movie => {
        const poster = "https://image.tmbd.org/t/p/w500" + movie.poster_path;
